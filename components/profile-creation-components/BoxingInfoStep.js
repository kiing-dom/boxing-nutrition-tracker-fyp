...
const BoxingInfoStep = ({ gender, boxingLevel, weightClass,
     handleGenderSelection, handleBoxingLevelSelection, handleWeightClassSelection,
    isStep1NextButtonEnabled, handleNextStep }) => {
